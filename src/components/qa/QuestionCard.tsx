      ...
      <div className="flex gap-6">
        ...
        <div className="flex flex-col items-center gap-3 min-w-[80px]">
          <div className="text-center">
            <div className="text-2xl font-black text-slate-900">{props.answers}</div>
            <div className="text-xs text-slate-500">câu trả lời</div>
          </div>
          <div className="text-center">
            <div className="text-lg font-bold text-slate-600">{props.views}</div>
        ...
        <div className="flex-1">
          ...
          <p className="text-slate-600 text-sm mb-4 line-clamp-2">{props.content}</p>
